...
nala install transmission-gtk gnome-tweaks dconf-editor alacritty solaar timeshift virt-manager gnome-boxes steam:i386 winetricks gnome-shell-extensions -y
