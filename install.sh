...
nala install transmission-gtk gnome-tweaks dconf-editor alacritty solaar timeshift virt-manager steam:i386 winetricks gnome-shell-extensions gnome-shell-extension-manager -y
