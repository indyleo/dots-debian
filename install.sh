...
nala install libhidapi-dev yarn webpack gpg openssl tldr htop trash-cli neofetch neovim vim lolcat cmatrix cmake hidapi-devel g++ cava wget python3 xdotool unzip python3-setuptools ripgrep fd-find luarocks golang-go shellcheck python3-venv ranger -y
...
nala install mesa-utils peek transmission-gtk dconf-editor gnome-tweaks solaar timeshift virt-manager steam:i386  -y
