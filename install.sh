...
echo "## Pkg Managers ##"
echo "##################"
nala install npm flatpak golang-go cargo python3-pip pipx -y
...
echo "############################"
nala install rhythmbox rhythmbox-plugins rhythmbox-data playerctl pamixer pavucontrol yt-dlp mpv peek obs-studio kdenlive audacity gimp vlc sxiv paprefs pulsemixer mediainfo ffmpegthumbnailer ffmpeg -y
