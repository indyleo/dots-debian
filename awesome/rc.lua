...
-- Starting Programs
awful.spawn.with_shell("sleep 1 && picom --experimental-backends --config ~/.config/picom/picom-polyawe.conf")
awful.spawn.with_shell("lxpolkit")
awful.spawn.with_shell("sxhkd")
awful.spawn.with_shell("nm-applet")
awful.spawn.with_shell("flameshot")
awful.spawn.with_shell("sleep 3 && conky -c ~/.config/conky/awesome/conky-polybar.conkyrc")
