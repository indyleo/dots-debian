...
echo "#####################"
flatpak install com.github.tchx84.Flatseal com.bitwarden.desktop org.prismlauncher.PrismLauncher xyz.xclicker.xclicker org.nickvision.tubeconverter flathub com.discordapp.Discord
